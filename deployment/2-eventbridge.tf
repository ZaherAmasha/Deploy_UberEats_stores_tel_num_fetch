...
resource "aws_cloudwatch_event_rule" "lambda_schedule" {
  ...
  # cron job runs on 2, 11, 19 and 28th of each month at 8:35 pm UTC (10:35 pm Beirut). Ensuring it runs only 4 times a month
  ...
  schedule_expression = "cron(35 20 2,11,19,28 * ? *)"
}
